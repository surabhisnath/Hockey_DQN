#!/bin/bash
#SBATCH --job-name=plot_hockey  # give it any name you want
...
#SBATCH --time=01:00:00     # job length: the job will run either until completion or until this timer runs out
...
singularity run ../../container.sif python3 plot_Hockey_RND.py
