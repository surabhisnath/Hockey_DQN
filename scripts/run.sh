...
#SBATCH --time=04:00:00     # job length: the job will run either until completion or until this timer runs out
...
singularity run ../../container.sif python3 runner.py --env hockey --numepisodes 15000 --numseeds 1 --epsilon 1 --minepsilon 0.2 --epsilondecay 0.9998 --savenum 003 --double
