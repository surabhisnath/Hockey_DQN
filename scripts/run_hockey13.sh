...
python /mnt/lustre/work/dayan/dno388/RL_project/scripts/runner.py --env hockey --fititerations 1 --numepisodes 30000 --numseeds 1 --epsilon 1 --minepsilon 0.15 --epsilondecay 0.9998 --savenum 013 --double