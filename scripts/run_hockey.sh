...
singularity run ../../container.sif python3 runner.py --env hockey --numepisodes 15000 --numseeds 1 --epsilon 1  --minepsilon 0.2 --epsilondecay 0.9998 --savenum 020 --opponent self --selfplayfilename agent_hockey_0_1.pth 
