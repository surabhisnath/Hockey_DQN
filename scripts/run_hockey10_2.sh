...
python /mnt/lustre/work/dayan/dno388/RL_project/scripts/runner.py --env hockey --numepisodes 10000 --agentfilename agent_hockey_0_10.pth --opponent strong --numseeds 1 --epsilon 1  --minepsilon 0.2 --epsilondecay 0.9998 --savenum 10_2 --per --dueling