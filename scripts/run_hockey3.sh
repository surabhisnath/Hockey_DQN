...
python /mnt/lustre/work/dayan/dno388/RL_project/scripts/runner.py --env hockey --numepisodes 20000 --numseeds 1 --epsilon 1  --minepsilon 0.2 --epsilondecay 0.9998 --savenum 3_20000 --double
