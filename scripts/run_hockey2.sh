...
singularity run ../../container.sif python3 runner.py --env hockey --fititerations 1 --numepisodes 30000 --numseeds 1 --epsilon 1 --minepsilon 0.15 --epsilondecay 0.9998 --savenum 011
